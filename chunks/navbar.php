<section class="fnavbar">
		<div class="navbar-fixed">
		    ...
		    <div class="nav-wrapper">
		      <a href="#" class="brand-logo">SanRaj Restro</a>
		      <a href="#" data-target="mobile-demo" class="sidenav-trigger"><i class="material-icons">menu</i></a>
		      <ul class="right hide-on-med-and-down">
		        <li><a href="index.php" class="hvr-grow">Home</a></li>
		        <li><a href="about-sanraj-restro.php" class="hvr-grow">About Us</a></li>
		        <li><a href="food-categories.php" class="hvr-grow">Categories</a></li>
		        <li><a href="foods.php" class="hvr-grow">Foods</a></li>
		        <li><a href="#" class="hvr-grow" onclick="toggleModal('Contact Info', 'Check the bottom Footer Section of the website for more info.');">Contact</a></li>
		  ...
		  <ul class="sidenav" id="mobile-demo">
		    <li><a href="/SanRaj Restro">Home</a></li>
	        <li><a href="/SanRaj Restro/about-sanraj-restro.php">About Us</a></li>
